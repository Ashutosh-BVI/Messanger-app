...
const Button:React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      !secondary && !danger && 'bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:bg-gradient-to-l hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 focus-visible:outline-sky-600'
      )}
    >
        {children}
    </button>
